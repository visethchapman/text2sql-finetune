...
TZ casts. Not a Claude replacement — a scaled-down specialist that closes
...
- **Frontier models still win on this task.** Claude Sonnet 4.5 scores 12/12 on the held-out eval; this model is a scaled-down specialist, not a Claude replacement. The value here is *proximity* — how close a 1.5B specialist can get to a frontier general model.
